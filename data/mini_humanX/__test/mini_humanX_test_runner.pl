...
main: {
    ...
    $pipeliner->add_commands(new Command("hisat2 --dta -x minigenome.fa -1 reads_1.fq.gz -2 reads_2.fq.gz | samtools view -Sb | samtools sort -o alignments.hisat2.bam", "hisat_align.ok"));
